...
$PAGE->set_url('/login/register_success.php');
$PAGE->set_context(context_system::instance());
$PAGE->set_pagelayout('login');
$PAGE->set_title(get_string('registrationsuccess', 'local_students'));
...
<div id="success-popup" class="modal">
    <div class="modal-content">
        <p><?php echo get_string('registrationsuccessmessage', 'local_students'); ?></p>
