...
$string['activity_name_help'] = 'Name displayed in course for this Video Upload activity module.';
...
<li>Enter a name and description for your app. Example: Video Upload Repository API</li>
...
$string['datasource:videotime_sessions_data_source'] = 'Video Upload sessions';
$string['datasource:videotime_stats_data_source'] = 'Video Upload stats';
...
$string['long'] = 'Long';
$string['managevideotimepluginplugins'] = 'Manage Video Upload extensions';
$string['managevideotimetabplugins'] = 'Manage Video Upload tab plugins';
...
<b>Preview image mode</b>: Displays video thumbnail on course page that links to activity (Video Upload Repository only).';
$string['modulename'] = 'Video Upload';
$string['modulename_help'] = 'The Video Upload activity enables the teacher
<ul>
...
';
$string['modulenameplural'] = 'Video Upload instances';
$string['modulenamepro_help'] = 'The Video Upload Pro activity enables the teacher
<ul>
    <li>to easily embed videos from Vimeo, just by adding the url</li>
    <li>to add content above and below of the video player</li>
...
We are constantly improving the plugin, so stay tuned for upcoming versions. You can see what we’re working on and add feature requests in our public roadmap on .
...
$string['pluginadministration'] = 'Video Upload administration';
$string['pluginname'] = 'Video Upload';
...
$string['privacy:metadata'] = 'The Video Upload activity module does not store any personal data.';
...
$string['settings'] = 'Video Upload settings';
...
$string['subplugintype_videotimeplugin'] = 'Video Upload Plugin';
$string['subplugintype_videotimeplugin_plural'] = 'Video Upload Plugins';
$string['subplugintype_videotimetab'] = 'Video Upload Tab';
$string['subplugintype_videotimetab_plural'] = 'Video Upload Tabs';
$string['tabinformation'] = 'Information';
$string['tablealias_vt'] = 'Video Upload';
$string['tabs'] = 'Tabs';
...
$string['totalvideotime'] = 'Total Video Upload: {$a->time}';
...
$string['videotime:addinstance'] = 'Add a new Video Upload module';
$string['videotime:view'] = 'View Video Upload video';
$string['videotime:view_report'] = 'View report (Pro only)';
$string['videotimelink'] = 'Link';
$string['videotimepluginpluginname'] = 'Video Upload extension name';
$string['videotimetabpluginname'] = 'Video Upload tab name';
$string['videotimetabplugins'] = 'Video Upload tab plugins';
