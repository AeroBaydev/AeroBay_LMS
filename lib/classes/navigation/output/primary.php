...
class primary implements renderable, templatable {
    ...
    protected function get_primary_nav($parent = null): array {
        ...
        foreach ($parent->children as $node) {
            ...
            // $url="";
            // if($node->text=='Home'){
            //     $url="<i class='fas fa-home'></i> ". $node->text;
            // }
            // else if($node->text=='Dashboard'){
            //     $url="<i class='fas fa-tachometer-alt'></i> ". $node->text;
            // }
            // else if($node->text=='My courses'){
            //     $url='<i class="fas fa-book"></i> '. $node->text;
            // }
            // else if($node->text=='Site administration'){
            //     $url='<i class="fas fa-cogs"></i> '. $node->text;
            // }
            // else{
            //      $url=$node->text;
