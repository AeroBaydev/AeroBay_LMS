...
$PAGE->set_url("$CFG->wwwroot/local/poc/assignschool/school.php?id=$pocId", array('id'=>$pocId));
$PAGE->set_pagelayout('course');
$PAGE->set_title('Assign School POC');
$PAGE->set_heading('Assign School POC');
if (is_siteadmin()) {
                
    $PAGE->navbar->add('POC Management', "$CFG->wwwroot/local/poc/poc_management.php");        
    $PAGE->navbar->add("Assign School's", "$CFG->wwwroot/local/poc/school.php?userId=$pocId");
}
else{
	$PAGE->navbar->add("Assign School's", "$CFG->wwwroot/local/poc/school.php?userId=$pocId");
