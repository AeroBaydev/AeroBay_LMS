...
$string['pocsuccess'] = 'POC Created Successfully!';
$string['state'] = 'State';
$string['selectschool'] = 'Select School';
$string['selectpoc'] = 'Select POC';
$string['selectrole'] = 'Select Role';
$string['poc_mapping'] = 'Assign POC into School';
$string['add_poc'] = 'Add POC';
$string['pocdelete'] = 'POC Deleted';
$string['recordsaved'] = 'School Assigned TO POC';
$string['updatesuccess'] = 'Updation Successfull';
$string['userexists'] = 'Username already Exist';
$string['poc:view'] = 'View POC';
$string['poc:edit'] = 'View edit';
$string['validemail'] = 'please enater valid email';
