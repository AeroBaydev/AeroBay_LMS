...
class card_table extends table_sql
{
    ...
    function __construct($uniqueid)
    {
        ...
        $columns = array('serialno', 'image','name','percentages','edit');
        $this->define_columns($columns);

        $headers = array('S.No', 'image','Name','Percentages', 'Action');
    ...
    function col_edit($values)
    {
        ...
        <a href='{$CFG->wwwroot}/local/sessioncard/delete_card.php?id={$values->sessioncardid}' class='btn btn-primary mr-2' title='Delete sessioncard'>
    ...
    function define_headers($headers)
    {
        ...
        $this->no_sorting('sessioncardtext');
