...
if (!$table->is_downloading()) {
    ...
    echo $OUTPUT->header();
    $heading_text = "Assessment Badge Management";
    ...
    echo html_writer::link(new moodle_url('/local/assessmentcard/addcard.php'), 'Add new Assessment Badge', array('class' => 'btn btn-primary'));
...
$fields = "bc.id as assessmentcardid , bc.name as name,bc.imgpath as imgpath ,bc.rang1 as rang1,bc.rang2 as rang2";
$from = "{assessmentcard} bc";
$where = "1=1 and bc.parentid=0";
$params = [];
