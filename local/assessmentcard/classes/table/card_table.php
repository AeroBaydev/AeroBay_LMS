...
class card_table extends table_sql
{
    ...
    function col_percentages($values)
{
    ...
    function col_edit($values)
    {
        ...
        <a href='{$CFG->wwwroot}/local/assessmentcard/delete_card.php?id={$values->assessmentcardid}' class='btn btn-primary mr-2' title='Delete assessmentcard'>
            <i class='fa fa-trash'></i>
        </a>
        <a href='{$CFG->wwwroot}/local/assessmentcard/edit_card.php?id={$values->assessmentcardid}' class='btn btn-primary mr-2' title='Edit assessmentcard'>
            <i class='fa fa-edit'></i>
        </a>
        <a href='{$CFG->wwwroot}/local/assessmentcard/subcardindex.php?id={$values->assessmentcardid}' class='btn btn-primary mr-2' title='Add sub  assessmentcard'>
