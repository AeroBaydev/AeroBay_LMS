...
$where = "1=1 and rp.usertype='$usertype' AND rp.pocid = $USER->id";
...
if ($table->is_downloading()) {
    ...
    $PAGE->navbar->add('RM/ARM Management', "$CFG->wwwroot/local/regionalpoc/rm_arm_manage.php?usertype=0");
    ...
    echo html_writer::link(new moodle_url('/local/regionalpoc/rm_arm_form.php'), 'Add New RM/ARM', array('class' => 'btn btn-primary mr-2'));
