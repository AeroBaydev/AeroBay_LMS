...
class card_table extends table_sql
{
    ...
    function col_percentages($value) {
        $mapping = [
            1 => '80%-90%',
            2 => '90%-95%',
            3 => '95%'
        ...
        return isset($mapping[$value->percentages]) ? $mapping[$value->percentages] : 'Unknown';
    }
    ...
    function col_edit($values)
    {
        ...
        <a href='{$CFG->wwwroot}/local/attendancecard/delete_card.php?id={$values->attendancecardid}' class='btn btn-primary mr-2' title='Delete attendancecard'>
    ...
    function define_headers($headers)
    {
        ...
        $this->no_sorting('attendancecardtext');
